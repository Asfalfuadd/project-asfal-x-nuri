...
<div class="content">
    <h2>Jasa Angkut Barang</h2>
    <p>Temukan layanan angkut barang terbaik untuk kebutuhan Anda.</p>
    <div class="angkut-list">
        <?php while($row = mysqli_fetch_assoc($data)): ?>
        <div class="angkut-card">
            <div class="image">Foto Angkut</div>
            <div class="angkut-info">
                <h3><?= $row['judul']; ?></h3>
